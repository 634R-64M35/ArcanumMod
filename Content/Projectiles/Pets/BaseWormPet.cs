...
namespace ArcanumMod.Content.Projectiles.Pets {
	...
	public abstract class BaseWormPet : ModProjectile {
		...
		public ArcPlayer ModOwner => Owner.GetModPlayer<ArcPlayer>();
		...
		public virtual void DrawWorm(Color lightColor, bool glow = false) {
			for (int i = SegmentCount() - 1; i >= 0; i--) {
				...
				Texture2D sprite = ModContent.Request<Texture2D>(ArcanumMod.AssetPath + currentSegment.TexturePath + (glow ? GlowmaskSuffix : "")).Value;
